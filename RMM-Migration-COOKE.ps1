...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Cooke_Associates-Cooke_Associates_Windows_OS_ITSPlatform_TKNa8699ecb-c908-4dbb-a94f-5b23d30f3706/MSI/setup"
# =====================================================================
