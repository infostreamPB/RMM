...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Main-Junior_Achievement_of_Palm_Beaches_Windows_OS_ITSPlatform_TKN5b872a8e-ef55-4097-94e3-8ede1fcd2e68/MSI/setup"
# =====================================================================
