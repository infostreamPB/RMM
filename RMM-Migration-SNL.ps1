...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Schmidt_Nichols-Schmidt_Nichols_Windows_OS_ITSPlatform_TKN9b4ae4ae-e62a-49dc-b59a-7819937c4b4e/MSI/setup"
# =====================================================================
