...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Main-Preservation_Foundation_of_Palm_Beach_Windows_OS_ITSPlatform_TKNd26d6301-8148-4308-b298-76a736a2dea4/MSI/setup"
# =====================================================================
