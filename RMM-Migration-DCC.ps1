...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Main-Dr._ColorChip_Corporation_Windows_OS_ITSPlatform_TKN5f12c002-1cf5-4520-8451-ed989b8d042b/MSI/setup"
# =====================================================================
