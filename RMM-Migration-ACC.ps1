...
# =====================================================================
$NewAgentUrl  = "https://prod.setup.itsupport247.net/windows/BareboneAgent/32/Acrylic_Co-Acrylic_Co_Windows_OS_ITSPlatform_TKN9a69e738-2a63-4d2f-95a9-2e75b9aa5e1d/MSI/setup"
# =====================================================================
